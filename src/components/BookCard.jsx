    ...
    return (
        <div className=" rounded p-[16px] shadow-md ">
            ...
            <div className="grid rounded-lg hover:scale-105 transition-all duration-300 relative group">
                ...
                <div className=""><button className="flex items-center   text-[#344256] bg-yellow-400 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 px-4 py-2 " ><IoCartOutline /> </button></div>
